...
class User(Base):
    ...
    created_at: Mapped[str] = mapped_column(DateTime, default=dt.datetime.now(dt.UTC), nullable=False)
    updated_at: Mapped[str] = mapped_column(DateTime, default=dt.datetime.now(dt.UTC),
                                            onupdate=dt.datetime.now(dt.UTC), nullable=False)
